...
var c_cppHighlightRules = function() {
    ...
    var keywordControls = (
        ...
        "otherwise|endcase|DEFAULT|CLASS|FROM|ENDCLASS|DATA|AS|CLASSDATA|CLASSVAR|CONSTRUCTOR|INIT|INLINE|VIRTUAL|METHOD|function|local|next|end|endif|return|switch|while|catch|operator|try|throw|using"
    );
