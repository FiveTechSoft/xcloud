...
var c_cppHighlightRules = function() {
    ...
    var keywordControls = (
        ...
        "each|in|otherwise|endcase|DEFAULT|CLASS|FROM|ENDCLASS|DATA|AS|CLASSDATA|CLASSVAR|CONSTRUCTOR|INIT|INLINE|VIRTUAL|METHOD|function|local|next|end|endif|return|switch|while|catch|operator|try|throw|using"
    );
    ...
    var builtinConstants = (
        ".T.|.F.|Super|Self|nil|NULL|true|false|TRUE|FALSE|nullptr"
    );
